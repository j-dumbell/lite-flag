...
func (r ApiHealthzGetRequest) Execute() (*HealthResponse, *http.Response, error) {
...
*/
func (a *HealthzAPIService) HealthzGet(ctx context.Context) ApiHealthzGetRequest {
	return ApiHealthzGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *HealthzAPIService) HealthzGetExecute(r ApiHealthzGetRequest) (*HealthResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HealthzAPIService.HealthzGet")
	if err != nil {
