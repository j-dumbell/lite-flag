...
func TestPostKey(t *testing.T) {
	...
	reqBody := oapi.ApiKeyInput{
		Name: "some-key",
		Role: oapi.ApiKeyInputRoleReadonly,
	}
	...
	var actualBody oapi.PostApiKeys201JSONResponse
	...
	assert.Equal(t, actualBody.Role, oapi.ApiKeyRole(reqBody.Role), "role")
